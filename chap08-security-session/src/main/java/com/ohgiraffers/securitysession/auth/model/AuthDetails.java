...
public class AuthDetails implements UserDetails {
    ...
    // 사용자의 아이디를 반환하는 메소드
    // UsernamePasswordAuthenticationToken 과 사용자의 아이디를 비교할 때 사용된다.
    @Override
    public String getUsername() {
        return loginUserDTO.getUserName();
    }

    // 계정 만료 여부를 표현 하는 메소드 . false 이면 해당 계정을 사용할 수 없다.
    @Override
    ...
    // 비밀번호 반복 실패로 일시적인 계정 lock 같은 경우 혹은 오랜 기간 비접속으로 휴면 처리
    @Override
    ...
    // false 이면 계정을 사용할 수 없다. 삭제 처리와 같은 경우
    @Override
